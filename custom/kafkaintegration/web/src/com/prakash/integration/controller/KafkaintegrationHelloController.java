 ...
 */
package com.prakash.integration.controller;
...
@Controller
public class KafkaintegrationHelloController
{
	@Autowired
	...
	{
		model.addAttribute("logoUrl", kafkaintegrationService.getHybrisLogoUrl(PLATFORM_LOGO_CODE));
		return "welcome";
	}
}
