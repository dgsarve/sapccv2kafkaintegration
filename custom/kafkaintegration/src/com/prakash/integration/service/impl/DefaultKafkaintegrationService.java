...
public class DefaultKafkaintegrationService implements KafkaintegrationService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultKafkaintegrationService.class);
	...
	{
		return DefaultKafkaintegrationService.class.getResourceAsStream("/kafkaintegration/sap-hybris-platform.png");
	}
